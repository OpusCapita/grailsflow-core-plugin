...
<!--
 ...
 -->
    ...
    <g:set var="displayKey" value="${view?.displayKey}"/>
    <g:set var="restriction" value="${view?.restriction}"/>

    <gf:listObjectsBox name="${parameterName}" searchClass="${variable.type}" displayKey="${displayKey}" value="${variable?.value}" restriction="${restriction}" styleClass="${styleClass}" readonly="${readOnly}"/>
