      ...
      <g:form controller="${params['controller']}" method="POST" enctype="multipart/form-data">
        ...
        <table>
          <tr>
            ...
            <td><g:select id="processClass" from="${processClasses}" name='processID'
        ...
        <br/>  
        <div class="buttons">
          <g:actionSubmit action="addJob" onclick="if (!checkRepeatInterval()) return false;" value="${msgs['grailsflow.command.addJob']}" class="button"/>
          &nbsp;
